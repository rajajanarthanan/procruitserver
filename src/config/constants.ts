...
export const ServerConstants = {
    initTwimlUrl: `${baseUrl}${ServerEndpoint.twilioInitCall}`,
    twiStatusCallBackUrl: `${baseUrl}${ServerEndpoint.twilioStatusCallBackUpdate}`,
    twiMakeCallUrl: `${baseUrl}${ServerEndpoint.twilioMakeCall}`,
    twiStopCallUrl: `${baseUrl}${ServerEndpoint.twilioStopCall}`,    
    twiCallWsUrl: `wss://perfectly-shining-flounder.ngrok-free.app/twilio/call`,
};


export const TwilioCallBackEvents = {
    initiated: "initiated",
    ringing: "ringing",
    answered: "answered",
    completed: "completed",
...
export const otpEmailHtmlBody= (otp: string) => ``;


export const resumeParsingPrompt = (chunk: string[], jdChunk: string[], parsedRes: Object) =>`
